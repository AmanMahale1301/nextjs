...
const CartDrawer = ({ isDrawerOpen, setIsDrawerOpen }) => {
  ...
  return (
    <div>
      {isDrawerOpen && (
        <div className="fixed top-0 right-0 h-full w-2/4 shadow-2xl bg-zinc-100 max-[768px]:w-full">
          <div className="">
            ...
            {total <= 1 ? (
              <div className="h-[65vw] flex-center flex-col">
              ...
              <>
                <div className="fixed bottom-10 right-0 w-2/4 max-[640px]:w-full">
